        ...
        <div class="form-group mt-2">
            <div class="input-group input-group-sm">
                <div class="input-group-prepend">
                    <span class="input-group-text ">{{ __('योजना संचालन गर्ने उपभोक्ता समितिको नाम:') }}
        ...
        <div class="form-group mt-2">
            <div class="input-group input-group-sm">
                ...
                <select name="ward_no" class="form-control form-control-sm">
                    ...
                    @for ($i = 1; $i < 20; $i++)
                        <option value="{{ $i }}"
                            {{ $list_registration_attribute == null ? '' : ($list_registration_attribute->ward_no == $list_registration_attribute->ward_no ? 'selected' : '') }}>
                            {{ Nepali($i) }}</option>
                    @endfor
                </select>
            </div>
