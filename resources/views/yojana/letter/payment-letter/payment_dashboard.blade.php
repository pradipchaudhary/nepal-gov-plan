    ...
    <div class="container-fluid">
        <div class="card ">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <h3 class="card-title">{{ __('अन्तिम भुक्तानीको पत्र') }}</h3>
                    </div>
                        ...
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('plan.letter.payment_letter.tippani', $reg_no) }}">{{ __('अन्तिम भुक्तानीको टिप्पणी') }}</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-3">
                        <ul class="users-list clearfix">
                            <li class="card shadow-lg" style="width:100%;">
                                ...
                                <a class="users-list-name mt-3 font-weight-bold"
                                    href="{{ route('plan.letter.final_account_payment_letter', $reg_no) }}">{{ __('आर्थिक प्रशासन शाखा पत्र') }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
