        ...
        <div class="card ">
            ...
            <div class="card-body">
                <div class="letter_wrap">
                    <form action="{{ route('print.program.letter.printWorkOrderLetter') }}" method="get" target="_blank">
                        ...
                        <div class="letter_inner">
                            ...
                            <div class="letter_subject">विषय:- कार्यादेश दिने सम्बन्धमा ।</div>
                            <div class="letter_body">
                                <p class="letter_greeting">श्रीमान्,
                                </p>
                                <p class="letter_text my-2">
                                    यस कार्यालयको स्वीकृत बार्षिक कार्यक्रम अनुसार देहायको कार्यक्रम संचालन गर्न श्री
                                    {{ $program->name }}ले यस कार्यालयमा दिएको निबेदन अनुसार
                                    {{ $work_order->venue }}मा
                                    मिति {{ Nepali($work_order->program_start_date_nep) }} देखि
                                    कार्यक्रम शुरु गरि मिति {{ Nepali($work_order->program_end_date_nep) }} भित्र
                                    कार्यक्रम
                                    सम्पन्न गर्ने गरि कार्यदेश दिनका लागी
                                    मनासिव देखिएकोले निर्णयार्थ पेश गर्दछु। 
                                </p>
