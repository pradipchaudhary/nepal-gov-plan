                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group mt-2">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select name="tole_bikas_samiti_id"
                                                class="form-control form-control-sm @error('tole_bikas_samiti_id') is-invalid @enderror"
                                                ...
                                                @foreach ($tole_bikas_samitis as $tole_bikas_samiti)
                                                    <option value="{{ $tole_bikas_samiti->id }}"
                                                        {{ $tole_bikas_samiti->id == $type->typeable->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    <table id="table1" width="100%" class="table table-bordered">
                                        ...
                                        <tbody id="row">
                                            @foreach ($tole_bikas_samiti_details as $tole_bikas_samiti)
                                                <tr>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ getSettingValueById($tole_bikas_samiti->position)->name }}"
                                                            disabled>
                                                    </td>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ $tole_bikas_samiti->name }}" disabled>
                                                    </td>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ Nepali($tole_bikas_samiti->ward_no) }}" disabled>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ returnGender($tole_bikas_samiti->gender) }}"
                                                            disabled>
                                                    </td>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ Nepali($tole_bikas_samiti->cit_no) }}" disabled>
                                                    </td>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ $tole_bikas_samiti->issue_district }}" disabled>
                                                    </td>
                                                    <td class="text-center"><input type="text"
                                                            class="form-control form-control-sm"
                                                            value="{{ Nepali($tole_bikas_samiti->contact_no) }}"
                                                            disabled>
                                                    </td>
                                                </tr>
                                            @endforeach
