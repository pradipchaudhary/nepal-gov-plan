        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('बैंक थप्नुहोस') }}</h5>
                ...
                <form method="post" action="{{ route('bank.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">{{ __('बैंकको नाम') }}<span id="name_group"
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">{{ __('बैंकको नाम (ENGLISH)') }}</span>
                                </div>
                                <input id="name_eng" name="name_eng" class="form-control" placeholder="" type="text"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">{{ __('बैंकको ठेगाना') }}</span>
                                </div>
                    ...
                    <table id="table1" width="100%" class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <td class="text-center font-weight-bold">{{ __('बैंकको नाम') }}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="" data-toggle="modal"
                                            data-target="#edit_bank{{ $bank->id }}"><i
                                                class="fa-solid fa-pen-to-square fa-2x"></i></a>
                                        {{-- this is modal for edit --}}
                                        <div class="modal fade" id="edit_bank{{$bank->id}}" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    <div class="input-group-prepend">
                                                                        <span
                                                                            class="input-group-text">{{ __('बैंकको नाम') }}<span
                                                                                id="name_group"
                                                                                class="text-danger font-weight-bold px-1">*</span></span>
                                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    <div class="input-group-prepend">
                                                                        <span
                                                                            class="input-group-text">{{ __('बैंकको नाम (ENGLISH)') }}</span>
                                                                    </div>
                                                                    <input id="name_eng" name="name_eng"
                                                                        class="form-control" placeholder="" type="text"
                                                                        value="{{ $bank->name_eng }}" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    <div class="input-group-prepend">
                                                                        <span
                                                                            class="input-group-text">{{ __('बैंकको ठेगाना') }}</span>
                                                                    </div>
