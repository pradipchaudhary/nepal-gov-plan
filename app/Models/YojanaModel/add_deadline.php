...
class add_deadline extends Model
{
    use HasFactory;
    ...
    public function setConsumerDateNepAttribute($value)
    {
        $this->attributes['consumer_date_nep'] = $value;
        $this->attributes['consumer_date_eng'] = convertBsToAd($value);
    }
